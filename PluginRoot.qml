...
Item {
  ...
  function handleMapClick(point) {
    ...
    try {
      ...
      mainWindow.displayToast("해당 위치의 필지는 찾았지만 19자리 PNU를 읽지 못했습니다.")
    } catch (e) {
      console.log("qfield-pnu-viewer selection error: " + e)
      mainWindow.displayToast("필지 선택 중 오류가 발생했습니다: " + e)
    }
  }
    ...
    Column {
      ...
      Rectangle {
        ...
        Column {
          ...
          Label { width: parent.width; text: "선택 필지"; font.pixelSize: 13; color: "#6B7280" }
          Label {
            width: parent.width
            text: currentPnu
            font.pixelSize: 20
